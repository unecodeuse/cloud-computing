...
<!-- Mirrored from tixia.dexignzone.com/laravel/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Dec 2021 18:25:23 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Zeynab Immob | @yield('title')</title>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="public/images/favicon.png">
						...
						<link href="../assetss/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet" type="text/css"/>
						<link href="../assetss/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet" type="text/css"/>
						<link href="../assetss/vendor/chartist/css/chartist.min.css" rel="stylesheet" type="text/css"/>
						<link href="../assetss/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css"/>
        ...
        ***********************************-->
        <div class="nav-header">
           {{--  <a href="index.html" class="brand-logo">
			...
			<div class="logo-header mostion logo-dark" style="background-color:white">
				<a href="/dashboard"><img src="images/logo-2.png" width="110px" height="80px" alt=""></a>
			</div>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<span class="mr-3">
										<i class="la la-user" style="color: #1c1f7b; font-size:20px">Mon compte</i>
									</span>                           </a>
...
<div class="deznav">
	<div class="deznav-scroll">
		<ul class="metismenu" id="menu">
			...
			<li><a class="has-arrow ai-icon" href="/liste_des_admins" aria-expanded="false">
				<i class="flaticon-381-settings-2"></i>
				<span class="nav-text">Administrateurs</span>
			</a>
		</li>
			<li><a class="has-arrow ai-icon" href="/liste_des_avocats" aria-expanded="false">
					<i class="flaticon-381-notepad"></i>
					<span class="nav-text">Avocats</span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/liste_des_immeubles" aria-expanded="false">
					<i class="flaticon-381-network"></i>
					<span class="nav-text">Immeubles</span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/liste_des_clients" aria-expanded="false">
		...
		<div class="footer">
            ...
            ***********************************-->
            <script src="../assetss/vendor/global/global.min.js" type="text/javascript"></script>
                        ...
                        <script src="../assetss/vendor/chart.js/Chart.bundle.min.js" type="text/javascript"></script>
                        <script src="../assetss/vendor/apexchart/apexchart.js" type="text/javascript"></script>
                        <script src="../assetss/vendor/bootstrap-datetimepicker/js/moment.js" type="text/javascript"></script>
                        <script src="../assetss/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
                        <script src="../assetss/vendor/peity/jquery.peity.min.js" type="text/javascript"></script>
                        <script src="../assetss/js/dashboard/dashboard-1.js" type="text/javascript"></script>
                        ...
                        <script src="../assetss/js/demo.js" type="text/javascript"></script>
                        <script src="../assetss/js/styleSwitcher.js" type="text/javascript"></script>
        ...
        <!-- Mirrored from tixia.dexignzone.com/laravel/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Dec 2021 18:26:37 GMT -->
        </html>